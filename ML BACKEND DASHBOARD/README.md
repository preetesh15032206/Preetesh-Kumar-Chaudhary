...
#include <Adafruit_BMP180.h>        // Pressure/temp sensor
...
|-------------|---|---|---|
| Temperature | DHT22, BMP180, DS18B20 | I2C/1-Wire | Use calibrated models |
| Humidity | DHT22, BME680 | DHT Protocol | ±3% accuracy recommended |
| Pressure | BMP180, BME680, MS5611 | I2C | Barometric sensor |
